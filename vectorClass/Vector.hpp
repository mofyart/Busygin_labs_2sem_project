...
template <typename TypeElement> void MyVector<TypeElement>::CleanVector() {
...
template <> MyVector<Institution*>::~MyVector() {
    capacity = 2;
    count = 0;
    ...
    Institution** newDataBase = new Institution*[capacity];
